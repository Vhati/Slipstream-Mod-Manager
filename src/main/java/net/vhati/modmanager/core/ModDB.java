...
public class ModDB {
	...
	/**
	 * Returns the internal Map of forum thread urls and hashes of their first
	 * posts' content.
	 */
	 ...
	 *
	 * The returned map contains two lists, keyed to constants: EXACT - All
	 * attributes match (excluding fileHash/fileVersion). FUZZY - Title and URL
	 * match, but not everything.
	 */
	...
	/**
	 * Collects ModInfo objects that differ only in version, and creates ModsInfo
	 * objects.
	 */
