...
public class FieldEditorPanel extends JPanel {
	public enum ContentType {
		WRAPPED_LABEL, LABEL, STRING, TEXT_AREA, INTEGER, BOOLEAN, SLIDER, COMBO, CHOOSER
	}
	...
	/**
	 * Constructs JComponents for a given type of value. A row consists of a static
	 * label, some JComponent, and a reminder label.
	 *
	 * The component and reminder will be accessable later via getter methods.
	 */
	public void addRow(String valueName, ContentType contentType) {
		...
		if (contentType == ContentType.WRAPPED_LABEL) {
			...
			valueArea.setBorder(BorderFactory.createCompoundBorder(BorderFactory.createEtchedBorder(),
